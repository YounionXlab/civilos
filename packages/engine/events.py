...
def chronicle_event(world: dict[str, Any], agents: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    if event_index == 0:
        return {
            ...
            "participant_professions": ["Fusion Engineer"],
            "participant_citizen_ids": [],
        }
    if event_index == 1:
        return {
            ...
            "participant_professions": ["Botanist"],
            "participant_citizen_ids": [],
        }
    if event_index == 2:
        return {
    ...
    if event_index == 3 and agents:
        ...
        return {
            ...
            "participant_professions": [],
            "participant_citizen_ids": [citizen["id"]],
        }
    return {
